  ...
  <Link to={`/restaurant/${restaurantId}`} state={restaurantId}>
    <div className="group flex flex-col cursor-pointer">
      <div className=" pb-1 group-hover:scale-105 transition-all duration-200 ease-linear border rounded-lg ">
        <div
          className="py-28 bg-cover mb-2 bg-center rounded-t-lg "
          style={{ backgroundImage: `url(${coverImage})` }}
        ></div>

        <div className="inline-flex text-lg items-center ml-2 mb-2 text-gray-700">
          <GiShoppingBag />
        ...
        <div className="border-t border-gray-300 flex justify-between mx-2">
          ...
          <span className="lowercase  text-gray-500 inline-flex items-center  p-1 mt-2 text-xs font-semibold">
            <ImLocation />
            &nbsp; {address}
          </span>
        </div>
